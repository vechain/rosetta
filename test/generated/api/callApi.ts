...
export class CallApi {
  ...
  public async call(
  ...
  ): Promise<{ response: http.IncomingMessage; body: CallResponse }> {
    const localVarPath = this.basePath + "/call";
    ...
    if (callRequest === null || callRequest === undefined) {
      throw new Error(
        "Required parameter callRequest was null or undefined when calling call.",
      );
    }
    ...
    let localVarRequestOptions: localVarRequest.Options = {
      ...
      json: true,
      body: ObjectSerializer.serialize(callRequest, "CallRequest"),
    };
        ...
        localVarRequest(localVarRequestOptions, (error, response, body) => {
          if (error) {
            ...
            if (
              ...
              body = ObjectSerializer.deserialize(body, "CallResponse");
